                    ...
                    </li>
                    {
                        session ? (
                            <>
                                ...
                                {session.user?.rol === 'admin' && (
                                    <li>
                                        <Link href={"/adminPages"} className="hover:text-blue-400">Panel de control</Link>
                                    </li>
                                )}
                                ...
                                <form action={async () => {
                                    ...
                                    <button type="submit" className="bg-red-500 text-white py-2 px-4 rounded-md mb-1 hover:text-red-100">
                                        Cerrar Sesión
                                    </button>
                                </form>
                            </>
